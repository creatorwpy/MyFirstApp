...
import com.mycompany.util.okhttp.ProgressListener;
import com.mycompany.util.okhttp.ProgressRequestBody;
import com.mycompany.util.okhttp.ProgressResponseBody;
import okhttp3.Call;
...
//        builder.post(multibuilder.build()).url(url);
        params(null);
