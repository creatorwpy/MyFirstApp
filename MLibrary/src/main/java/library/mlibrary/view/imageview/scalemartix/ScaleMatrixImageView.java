package library.mlibrary.view.imageview.scalemartix;
...
public class ScaleMatrixImageView extends ImageView {
    ...
    public void setMAX_SCALE(float scale) {
        MAX_SCALE = scale;
    }
    ...
    public ScaleMatrixImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private Runnable mClickRunnable = new Runnable() {
        ...
        public void run() {
            if (mClickListener != null) {
                mClickListener.onClick(ScaleMatrixImageView.this);
            }
        }
    };
