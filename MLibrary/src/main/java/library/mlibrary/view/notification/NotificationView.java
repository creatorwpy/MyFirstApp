...
public class NotificationView {
    ...
    private NotificationView(Activity activity, CharSequence text, Effects effects, ViewGroup viewGroup) {
    ...
    private NotificationView(Activity activity, CharSequence text, Effects effects, ViewGroup viewGroup, Configuration configuration) {
    ...
    public static NotificationView build(Activity activity, CharSequence text, Effects effects, int viewGroupResId) {
        return new NotificationView(activity, text, effects, (ViewGroup) activity.findViewById(viewGroupResId));
    }

    public static NotificationView build(Activity activity, CharSequence text, Effects effects, int viewGroupResId, Configuration configuration) {
        return new NotificationView(activity, text, effects, (ViewGroup) activity.findViewById(viewGroupResId), configuration);
    }
    ...
    private TextView initializeTextView() {
        ...
        text.setTextColor(this.configuration.textColor);
        text.setBackgroundColor(this.configuration.backgroundColor);
    ...
    private ImageView initializeImageView() {
        ...
        image.setBackgroundColor(this.configuration.iconBackgroundColor);
    ...
    public NotificationView setIcon(Drawable iconDrawable) {
        this.iconDrawable = iconDrawable;
        return this;
    }

    public NotificationView setIcon(int iconRes) {
        this.iconRes = iconRes;
        return this;
    }

    public NotificationView setOnClickListener(View.OnClickListener onClickListener) {
