package library.mlibrary.view.recyclerview.grouprecyclerview.caching;
...
public class HeaderViewCache implements HeaderProvider {
  ...
  public HeaderViewCache(GroupRecyclerImp adapter,
  ...
  public View getHeader(RecyclerView parent, int position) {
    ...
    if (header == null) {
      RecyclerView.ViewHolder viewHolder = mAdapter.onCreateHeaderViewHolder(parent,mAdapter.getGroupItemType(position));
