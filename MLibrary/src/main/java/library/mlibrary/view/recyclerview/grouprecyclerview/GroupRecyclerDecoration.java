...
import library.mlibrary.view.recyclerview.grouprecyclerview.caching.HeaderProvider;
import library.mlibrary.view.recyclerview.grouprecyclerview.caching.HeaderViewCache;
import library.mlibrary.view.recyclerview.grouprecyclerview.calculation.DimensionCalculator;
import library.mlibrary.view.recyclerview.grouprecyclerview.rendering.HeaderRenderer;
import library.mlibrary.view.recyclerview.grouprecyclerview.util.LinearLayoutOrientationProvider;
import library.mlibrary.view.recyclerview.grouprecyclerview.util.OrientationProvider;
...
public class GroupRecyclerDecoration extends RecyclerView.ItemDecoration {
  ...
  public GroupRecyclerDecoration(GroupRecyclerImp adapter) {
    this(adapter, new LinearLayoutOrientationProvider(), new DimensionCalculator(), null);
  }

  public GroupRecyclerDecoration(GroupRecyclerImp adapter, ItemVisibilityAdapter visibilityAdapter) {
    this(adapter, new LinearLayoutOrientationProvider(), new DimensionCalculator(), visibilityAdapter);
  }

  private GroupRecyclerDecoration(GroupRecyclerImp adapter, OrientationProvider orientationProvider,
  ...
  private GroupRecyclerDecoration(GroupRecyclerImp adapter, HeaderRenderer headerRenderer,
