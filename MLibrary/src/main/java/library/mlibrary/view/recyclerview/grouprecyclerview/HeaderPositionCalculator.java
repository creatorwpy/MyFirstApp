...
public class HeaderPositionCalculator {
    ...
    public HeaderPositionCalculator(GroupRecyclerImp adapter, HeaderProvider headerProvider,
    ...
    public boolean hasStickyHeader(View itemView, int orientation, int position) {
        ...
        return offset <= margin && mAdapter.showHeader(position);
    }
    ...
    public boolean hasNewHeader(int position, boolean isReverseLayout) {
        ...
        if (!mAdapter.showHeader(position)) {
//            LogDebug.d(false + "|position=" + position + "|headerId=" + headerId );
            return false;
        }
        ...
        boolean result = position == firstItemPosition || (headerId != nextItemHeaderId);
//        LogDebug.d(result + "|position=" + position + "|nextItemPosition=" + nextItemPosition+ "|headerId=" + headerId + "|nextItemHeaderId=" + nextItemHeaderId);
        return result;
    }
