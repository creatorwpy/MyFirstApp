...
package library.mlibrary.view.progress.roundcorner;
...
import library.mlibrary.view.progress.roundcorner.common.BaseRoundCornerProgressBar;
...
public class IconRoundCornerProgressBar extends BaseRoundCornerProgressBar implements View.OnClickListener {
    ...
    protected void initStyleable(Context context, AttributeSet attrs) {
        ...
        int colorIconBackgroundDefault = context.getResources().getColor(R.color.gray);
